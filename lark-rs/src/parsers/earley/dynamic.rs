...
impl EarleyParser {
    ...
    pub(crate) fn scan_dynamic(
        ...
        let mk_token = |term: SymbolId, value: &str, end_step: usize| Token {
            ...
            line: checked_pos(lines[i]),
            column: checked_pos(cols[i]),
            end_line: checked_pos(lines[end_step]),
            end_column: checked_pos(cols[end_step]),
            ...
            start_pos: checked_pos(i),
            end_pos: checked_pos(end_step),
        };
